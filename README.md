...
Navmesh 기법은 가장 많이 쓰는 3d 모델링 길찾기 방법이지만 이번 프로젝트는 웹에서도 경로 탐색 공간을 수정할 수 있게 하는것을 목표로 하고 있습니다. Navmesh를 웹에서도 수정할 수 있지만 연산이 많이 들어가기 때문에 비효율적이라고 생각했습니다. 따라서 Navmesh를 이용하지 않고 3d 건물 공간을 노드와 간선만을 이용해서 최단경로 탐색과 수정하는데 필요한 연산을 줄이는것을 고려했습니다
